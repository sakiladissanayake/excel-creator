...
import com.bpoconnect.automation.excelcreator.exceptions.NotSupportedException;
...
public class StreamingRow implements Row {
	...
	/**
	 * Get the cell representing a given column (logical cell) 0-based. If you ask
	 * for a cell that is not defined, you get a null.
	 *
	 * @param cellnum
